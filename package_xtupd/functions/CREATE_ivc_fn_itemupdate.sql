...
DECLARE
 ...
 (
  SELECT itemupdate_number, itemupdate_descrip1, itemupdate_descrip2, 
       itemupdate_classcode_code, itemupdate_comments, 
       CASE 
       ...
       END AS _sold, 
       itemupdate_prodweight, itemupdate_packweight, itemupdate_prodcat_code, 
       itemupdate_listprice, itemupdate_listcost, itemupdate_extdescrip, itemupdate_maxcost, 
...
LOOP
    ...
    IF (_r.itemupdate_comments IS NOT NULL) THEN
      ...
      IF (LENGTH(_r.item_comments) > 0) THEN
